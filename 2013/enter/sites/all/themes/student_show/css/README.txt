...
To use these stylesheets, rename the files and student_show with the name of your theme.
...
student_show-alpha-default.css
...
student_show-alpha-default-narrow.css  
...
student_show-alpha-default-normal.css
...
student_show-alpha-default-wide.css
